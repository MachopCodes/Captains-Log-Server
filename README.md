...
This template contains a project, `nautical_trip_planner`, and an app, `api`, which are set up complete with user authentication and an example resource, `trip`, which has an example user ownership implementation.
...
1. Replace all instances of `nautical_trip_planner` with your application name. This includes the folder included in this repository.
...
Before deploying, make sure you have renamed your project folder and replaced all instances of `nautical_trip_planner` with your app's name.
